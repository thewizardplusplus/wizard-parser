...
@test "lexer: base_identifier, an one upper letter" {
	declare -r INPUT="T"
	declare -r OUTPUT='[{"type": "base_identifier", "value": "T"}]'
	io_test
}
...
@test "lexer: base_identifier, an one underscore" {
	declare -r INPUT="_"
	declare -r OUTPUT='[{"type": "base_identifier", "value": "_"}]'
	io_test
}

@test "lexer: base_identifier, some upper letters" {
	declare -r INPUT="TEST"
	declare -r OUTPUT='[{"type": "base_identifier", "value": "TEST"}]'
	io_test
}
...
@test "lexer: base_identifier, some underscores" {
	...
	declare -r OUTPUT='[{"type": "base_identifier", "value": "_____"}]'
	io_test
}

@test "lexer: base_identifier, an one underscore and some digits" {
	declare -r INPUT="_12345"
	declare -r OUTPUT='[{"type": "base_identifier", "value": "_12345"}]'
	io_test
}
...
@test "lexer: base_identifier, some upper letters and underscores" {
	...
	declare -r OUTPUT='[
		{"type": "base_identifier", "value": "SOME_SIMPLE_TEST"}
	]'
	io_test
}
...
@test "lexer: base_identifier, some upper letters, underscores and digits" {
	...
	declare -r OUTPUT='[
		{"type": "base_identifier", "value": "SOME_SIMPLE_TEST_12"}
	]'
	io_test
}
...
@test "lexer: base_identifier, some upper and lower letters" {
	...
	declare -r OUTPUT='[{"type": "base_identifier", "value": "SomeSimpleTest"}]'
	io_test
}
...
@test "lexer: base_identifier, some upper and lower letters and digits" {
	...
	declare -r OUTPUT='[
		{"type": "base_identifier", "value": "SomeSimpleTest12"}
	]'
	io_test
}
